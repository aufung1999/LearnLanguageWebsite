...
function AddLangBtn() {
  ...
  return (
    <>
        ...
        {
            getLangfromFB && getLangfromFB.map((element) => {
                return <div className="d-flex justify-content-around" key={element.id}>
                          <button type="button" className="btn mb-2 mb-md-0 btn-round btn-outline-light btn-block border-50 text-secondary "
                        key={element.id}
